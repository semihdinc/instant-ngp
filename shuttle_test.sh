...
python ./scripts/run.py --mode nerf --scene ./data/nerf/shuttle --gui --load_snapshot ./data/nerf/shuttle/hashgrid.msgpack

# #Train the model with selected configurations
# python ./scripts/run.py --mode nerf --train \
#                         --scene ./data/nerf/shuttle \
#                         --network hashgrid.json \
#                         --save_snapshot ./data/nerf/shuttle/hashgrid.msgpack \
#                         --n_steps 30000

# #Render 3 RGB frames from toyota imageset
# python ./scripts/run.py --mode nerf \
#                         --scene ./data/nerf/shuttle \
#                         --load_snapshot ./data/nerf/shuttle/hashgrid.msgpack \
#                         --screenshot_transforms ./data/nerf/shuttle/transforms.json \
#                         --screenshot_frames 0 15 17 22\
#                         --screenshot_dir ./data/nerf/shuttle/screenshots/ \
